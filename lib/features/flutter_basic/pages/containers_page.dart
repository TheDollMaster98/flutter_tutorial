...
textAlign: TextAlign.center,
            ...
            explanationText("Il Container possiamo vederlo come se fosse un div in HTML."),
    ...
    child: Center(
      child: Text(
        ...
        textAlign: TextAlign.center,
            ...
            explanationText("È possibile utilizzare SizedBox anche per dare spazio tra gli elementi."),
            propertyExample(
