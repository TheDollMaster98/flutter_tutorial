...
class DialogPage extends StatelessWidget {
  ...
  /// Mostra un dialogo personalizzato per inviare un'email
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  style: ButtonStyle(
                    ...
                    foregroundColor: WidgetStatePropertyAll(Colors.redAccent.shade700),
                  ),
  ...
  /// Mostra un AlertDialog per errori
  ...
  /// Corpo della pagina tutorial con esempi e codice
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          explanationText(
            "I Dialog sono finestre di dialogo che appaiono sopra il contenuto principale. "
                "Sono utili per mostrare messaggi, avvisi o richiedere conferme.",
          ),
  ...
  builder: (context) => Dialog(
    ...
    child: Container(
      ...
      child: Column(
        ...
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text("Componi la tua email", style: TextStyle(fontWeight: FontWeight.bold)),
          Divider(),
          TextField(
            minLines: 3,
            maxLines: 5,
            decoration: InputDecoration(hintText: "Il tuo messaggio"),
          ),
          Divider(),
          SizedBox(
            width: double.infinity,
...
showDialog(
  context: context,
  builder: (context) => SimpleDialog(
    title: Text("Scegli la tipologia di email da mandare"),
    children: [
      SimpleDialogOption(
        onPressed: () => Navigator.pop(context),
        child: Text("Singolo destinatario"),
      ),
      SimpleDialogOption(
        onPressed: () => Navigator.pop(context),
        child: Text("Multipli destinatari"),
      ),
    ],
  ),
);
...
showDialog(
  context: context,
  builder: (context) => AlertDialog(
    title: Text("Gmail è down"),
    content: Text("Il servizio non è attualmente disponibile!"),
    actions: [
      TextButton(
        onPressed: () => Navigator.pop(context),
        child: Text("Cancella"),
