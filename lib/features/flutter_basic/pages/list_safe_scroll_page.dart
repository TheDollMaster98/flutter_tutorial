...
class ListSafeScrollPage extends StatelessWidget {
  const ListSafeScrollPage({super.key});
  ...
  child: ListView.separated(
    ...
    separatorBuilder: (context, index) => Divider(
      color: index % 2 == 0 ? Colors.blue : Colors.red,
            ...
            const SizedBox(height: 10),
            explanationText(
              "SafeArea è un widget che inserisce il suo figlio con padding sufficiente a evitare le aree intrinsecamente difficili da usare del dispositivo, come la tacca, la barra di stato e le aree di comando.",
            ),
            propertyExample(
              "Esempio di SafeArea",
              SafeArea(
    ...
    child: const Center(
      child: Text(
        ...
        style: TextStyle(color: Colors.white, fontSize: 16),
            ...
            const SizedBox(height: 10),
            explanationText(
              "SingleChildScrollView è un widget che consente di scorrere il contenuto quando è più grande dello schermo disponibile. È utile per liste di elementi o contenuti lunghi.",
            ),
            propertyExample(
      ...
      children: List.generate(
        ...
        (index) => Padding(
          ...
          child: Text('Elemento \$index',
            ...
            const SizedBox(height: 10),
            explanationText(
              "In questo esempio completo, utilizziamo sia SafeArea che SingleChildScrollView per mostrare una lista di 100 elementi con padding, evitando le aree critiche del dispositivo.",
            ),
            propertyExample(
