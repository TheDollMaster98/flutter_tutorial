...
import 'package:flutter_tutorial/core/model/home_page_model.dart';
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: GridView.builder(
          // Griglia 2 colonne con padding e spaziatura
          ...
          gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
            ...
            childAspectRatio: 3 / 4, // Modifica il rapporto d'aspetto per rendere le card meno alte
          ),
